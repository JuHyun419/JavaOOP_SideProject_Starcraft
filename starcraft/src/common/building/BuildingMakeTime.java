...
public class BuildingMakeTime {
	...
	public static final int MISSILETURRET_TIME = 19;
	
	public static final int ACADEMY_TIME = 50;
	
	public static final int BUNKER_TIME = 19;
	
	public static final int FACTORY_TIME = 50;
	
	public static final int STARPORT_TIME = 44;
	
	public static final int SCIENCEFACILITY_TIME = 38;

	public static final int ARMORY_TIME = 50;
	
	public static final int COMSAT_TIME = 25;
}
