...
public class unitPrice {
	...
	public static final int GHOST_M = 25;
	public static final int GHOST_G = 75;
	...
	public static final int GOLIATH_M = 100;
	public static final int GOLIATH_G = 50;
	...
	public static final int SCIENCEVESSEL_M = 100;
	public static final int SCIENCEVESSEL_G = 225;
	
	public static final int BATTLECRUISER_M = 400;
	public static final int BATTLECRUISER_G = 300;
